...
vesa_detect()
{
    ...
    vesa_x_center = 0; // (vesa_x_res - 640) / 2;
    vesa_y_center = 0; // (vesa_y_res - 480) / 2;
 ...
 * colour mode. The first 240 palette entries are * used by
 * the tile set; the last 16 are reserved for text.
 *
 */
static boolean
