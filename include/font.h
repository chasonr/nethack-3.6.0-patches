...
/* For Unicode lookup, a three level tree provides constant-time access to
   ...
   will populate only plane 0, and Unicode defines only planes 0, 1, 2, 15 and
   16.
...
extern struct BitmapFont *FDECL(load_font, (const char *filename));
extern void FDECL(free_font, (struct BitmapFont *font));
extern const unsigned char *FDECL(get_font_glyph, (
